...
**Solution**
 Runtime: 32 ms, faster than 92.68% of Swift online submissions for Richest Customer Wealth.
 Memory Usage: 14 MB, less than 73.17% of Swift online submissions for Richest Customer Wealth.

 */

import Foundation

struct MaximumWealth{
    func maximumWealth(_ accounts: [[Int]]) {
        var maxWealth = 0
